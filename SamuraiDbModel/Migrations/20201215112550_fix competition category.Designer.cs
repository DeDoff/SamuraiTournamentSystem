...
namespace SamuraiDbModel.Migrations
{
    ...
    [Migration("20201215112550_fix competition category")]
    partial class fixcompetitioncategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SamuraiDbModel.Referee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SamuraiDbModel.SportClub", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SamuraiDbModel.Trainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SamuraiDbModel.Sportsman", b =>
                {
                    b.HasOne("SamuraiDbModel.SportClub", "SportClub")
                        .WithMany("Sportsmens")
                        .HasForeignKey("SportClubId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SamuraiDbModel.Trainer", "Trainer")
                        .WithMany("Sportsmens")
            ...
            modelBuilder.Entity("SamuraiDbModel.Trainer", b =>
                {
                    b.HasOne("SamuraiDbModel.SportClub", "Club")
                        .WithMany("Trainers")
