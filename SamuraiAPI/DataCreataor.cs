...
using SamuraiLogic;
using SamuraiLogic.DistributionOfMatches;
...
{
    public class DataCreataor:IDataCreator
    {
        public void InitDbDefault()
        {
            ...
            {
                //пользователи
                db.Users.Add(new User() { CreatedDate = DateTime.Now, FirstName = "Super", LastName = "Root", Login = "root", PasswordHash = "password", Roles = new List<UserRole>() { new UserRole() { Name = "Super admin" } } });
                db.SaveChanges();
        ...
        public List<Referee> CreateRefereesFromTainers()
        {
        ...
        public List<CompetitionCategory> CreateCompetitionCategoriesFromDb(Competition competition, List<SportCategory> sportCategories)
        {
        ...
        public List<SportCategory> CreateSportCategories(List<AgeGroup> ageGroups, List<WeightGroup> weightGroups, List<SportCategoryType> types, List<Sex> sexes)
        {
        ...
        public bool DecreaseAray(int[] array, int[] baseArrayValues, int lastIndex)
        {
            if (lastIndex < 0)
                return false;
        ...
        public List<Sportsman> GenerateSportsmans(int sportnsmansCount, List<Sex> sexes, List<Grade> grades, List<AgeGroup> ages, List<WeightGroup> weights)
        {
        ...
        public List<Trainer> ShuffleTrainersBetweenClubs(List<SportClub> clubs, List<Trainer> trainers)
        {
            Random rnd = new Random();
        ...
        public List<Sportsman> ShuffleSportsmansBetweenTainers(List<Trainer> trainers, List<Sportsman> sportsmans)
        {
            Random rnd = new Random();
